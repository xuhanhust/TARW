...
from node2vec import alias
from node2vec import utils
...
class RandomWalker:
    ...
    def simulate_walks(self, id, num_walks, walk_length, workers=1, verbose=0):
        ...
        results = Parallel(n_jobs=workers, verbose=verbose, )(
            delayed(self._simulate_walks)(id, nodes, num, walk_length) for num in
    ...
    def _simulate_walks(self, id, nodes, num_walks, walk_length,):
        walks = []
